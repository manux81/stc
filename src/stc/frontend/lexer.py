...
class IECLexer(Lexer):
    ...
    tokens = { 
        ...
        # IEC 61131-3 Edition 3 object-oriented extensions.
        CLASS, END_CLASS, METHOD, END_METHOD, INTERFACE, END_INTERFACE,
        EXTENDS, IMPLEMENTS, FINAL, ABSTRACT, OVERRIDE,
        PUBLIC, PRIVATE, INTERNAL, PROTECTED, THIS, SUPER,
...
##########################################
    ...
    IDENTIFIER['END_CLASS'] = END_CLASS
    IDENTIFIER['METHOD'] = METHOD
    IDENTIFIER['END_METHOD'] = END_METHOD
    IDENTIFIER['INTERFACE'] = INTERFACE
    IDENTIFIER['END_INTERFACE'] = END_INTERFACE
    IDENTIFIER['EXTENDS'] = EXTENDS
    IDENTIFIER['IMPLEMENTS'] = IMPLEMENTS
    IDENTIFIER['FINAL'] = FINAL
    IDENTIFIER['ABSTRACT'] = ABSTRACT
    IDENTIFIER['OVERRIDE'] = OVERRIDE
    IDENTIFIER['PUBLIC'] = PUBLIC
    IDENTIFIER['PRIVATE'] = PRIVATE
    IDENTIFIER['INTERNAL'] = INTERNAL
    IDENTIFIER['PROTECTED'] = PROTECTED
